...
#SBATCH --export=ALL
#SBATCH --gres=gpu:1
#SBATCH --job-name "STREAM_INFERENCE_COVERAGE_MLP_BN_MARGINALIZED_BIAS"
#SBATCH --mem-per-cpu=5000
#SBATCH --ntasks=1
#SBATCH --output "logging/coverage_mlp_bn_marginalized_bias_%a.log"
#SBATCH --parsable
#SBATCH --requeue
...
out=$BASE/out/coverage/$EXPERIMENT_BATCH_SIZE/marginalized/$EXPERIMENT_ACTIVATION/coverage-bias-$EXPERIMENT_TASK_COVERAGE-mlp-bn-marginalized-$suffix.npy
