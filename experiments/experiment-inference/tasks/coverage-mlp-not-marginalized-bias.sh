...
#SBATCH --ntasks=1
#SBATCH --output "logging/coverage_mlp_not_marginalized_bias_%a.log"
#SBATCH --parsable
#SBATCH --requeue
...
out=$BASE/out/coverage/$EXPERIMENT_BATCH_SIZE/not-marginalized/$EXPERIMENT_ACTIVATION/coverage-bias-$EXPERIMENT_TASK_COVERAGE-mlp-not-marginalized-$suffix.npy
