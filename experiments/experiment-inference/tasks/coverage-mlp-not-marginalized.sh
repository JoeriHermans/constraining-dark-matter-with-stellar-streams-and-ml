...
#SBATCH --ntasks=1
#SBATCH --output "logging/coverage_mlp_not_marginalized_%a.log"
#SBATCH --parsable
#SBATCH --requeue
...
out=$BASE/out/coverage/$EXPERIMENT_BATCH_SIZE/not-marginalized/$EXPERIMENT_ACTIVATION/coverage-$EXPERIMENT_TASK_COVERAGE-mlp-not-marginalized-$suffix.npy
